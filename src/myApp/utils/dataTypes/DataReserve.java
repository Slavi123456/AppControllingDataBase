...
public class DataReserve extends DataBase {
    private int area;
    private LocalDate date_of_creation;

    public  DataReserve(String img_path, String name) {
        super(img_path, name);
        setArea(0);
        setDate_of_creation(LocalDate.now());
    }

    public  DataReserve(String img_path, String name, int area, LocalDate date_of_creation) {
        super(img_path, name);
        setArea(area);
    ...
    public String toString() {
        return super.toString() + String.format("\n  Reserve Details: Area: %d m², Creation Date: %s",
                this.area,
